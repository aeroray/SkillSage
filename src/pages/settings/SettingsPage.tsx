  ...
  return (
    <div>
      ...
      <div className="settings-grid">
        <section className="surface-card p-6" aria-labelledby="appearance-title">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 id="appearance-title" className="text-base font-medium text-foreground">外观</h2>
              <p className="mt-1 text-sm leading-6 text-muted-foreground">选择界面亮度。系统模式会跟随操作系统设置变化。</p>
            </div>
          </div>
          <div className="mt-6 flex items-center justify-between gap-4 rounded-md bg-muted p-4 max-sm:items-start max-sm:flex-col">
            <div>
        ...
        <section className="surface-card p-6" aria-labelledby="security-title">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 id="security-title" className="text-base font-medium text-foreground">安全与连接</h2>
      ...
      <section className="surface-card mt-6 flex items-start gap-4 p-6" aria-labelledby="about-title">
        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-muted text-muted-foreground">
          <Info aria-hidden="true" className="h-5 w-5" />
        </div>
        <div>
          <h2 id="about-title" className="text-base font-medium text-foreground">关于 SkillSage</h2>
          <p className="mt-1 text-sm leading-6 text-muted-foreground">桌面端 AI Agent 技能管理器，当前版本专注于建立可靠、清晰的产品基线。</p>
          <p className="mt-3 text-xs text-muted-foreground">v0.1.0 · Phase 1 foundation</p>
        </div>
      </section>
    </div>
  );
